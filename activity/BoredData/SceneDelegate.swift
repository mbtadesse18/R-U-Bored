...
//Alright so in this bit I am attempting to make the app take us to the task navigation route
//When the user logs in and signs up. To do this i have to change the view controller's identifier
